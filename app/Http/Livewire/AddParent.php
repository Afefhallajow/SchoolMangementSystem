...
class AddParent extends Component
{
    ...
    public $show_table=true, $updateMode = false,$photos,$Parent_id;
...
$Address_Mother, $Religion_Mother_id;
    ...
    public function updated($propertyName)
    {
        $this->validateOnly($propertyName, [
            ...
            'National_ID_Father' => 'required|string|min:10|max:20|regex:/[0-9]{9}/',
            'Passport_ID_Father' => 'min:10|max:20',
            'Phone_Father' => 'min:10',
...
//echo $this->Parent_id;
    ...
    $parent=    ParentAttachment::where('parent_id',$id)->get();

    foreach ($parent as $paren)
{       ParentAttachment::findOrFail($paren->id)->delete();
}
$My_par =        My_Parent::findOrFail($id);
    $path='app\parent_attachments\ '.$My_par->National_ID_Father;
        $files=Storage::allFiles('parent_attachments'.$My_par->National_ID_Father);
